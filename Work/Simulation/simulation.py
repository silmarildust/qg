...
class Simulation:
    ...
    def time_step(self):
        ...
        for it_count in range(self.steps - 1):
            ...
            if self.sponge is not None:
                nlo_sponge_1=self.nonlinear_operator.sponge_penalty_v1(xi_sponge,q_sol_h_1, p_sol_h_1, u_sol_h_1, v_sol_h_1)
            ...
            #Explicitly force gauge (only for sponged version)
            ans[0,0]=0
